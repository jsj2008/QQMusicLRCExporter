...
@class APASIDataDecompressor, NSArray, NSData, NSDate, NSDictionary, NSError, NSInputStream, NSMutableArray, NSMutableData, NSMutableDictionary, NSNumber, NSOutputStream, NSRecursiveLock, NSString, NSTimer, NSURL;
@protocol APASICacheDelegate, APASIHTTPRequestDelegate, APASIHTTPRequestDelegate><APASIProgressDelegate, APASIProgressDelegate;
...
@interface APASIHTTPRequest : NSOperation <NSCopying>
{
    ...
    APASIHTTPRequest *PACFileRequest;
...
+ (id)sharedQueue;
+ (void)APReachabilityChanged:(id)arg1;
+ (_Bool)isNetworkReachableViaWWAN;
+ (void)unsubscribeFromNetworkAPReachabilityNotifications;
+ (void)registerForNetworkAPReachabilityNotifications;
...
+ (void)performInvocation:(id)arg1 onTarget:(id *)arg2 releAPASIngObject:(id)arg3;
...
@property(retain, nonatomic) APASIHTTPRequest *PACFileRequest; // @synthesize PACFileRequest;
...
@property(retain) APASIDataDecompressor *dataDecompressor; // @synthesize dataDecompressor;
...
@property id <APASICacheDelegate> downloadCache; // @synthesize downloadCache;
...
@property APASIHTTPRequest *mainRequest; // @synthesize mainRequest;
...
- (void)addBAPASIcAuthenticationHeaderWithUsername:(id)arg1 andPassword:(id)arg2;
