...
@class MpInfo, NSError, NSString, RequestInfo;

@protocol IAPPayDelegate <NSObject>

@optional
- (void)onNetWorkEorror:(int)arg1 withRequestInfo:(RequestInfo *)arg2;
- (void)onLaunMpFailue:(RequestInfo *)arg1 withErrorMessage:(NSString *)arg2 withErrorCode:(int)arg3;
- (void)onLaunMpFinish:(RequestInfo *)arg1 withMpinfo:(MpInfo *)arg2;
