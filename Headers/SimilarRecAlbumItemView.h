...
@protocol SimilarRecAlbumItemViewDelegate;

@interface SimilarRecAlbumItemView : UIView
{
    id <SimilarRecAlbumItemViewDelegate> _delegate;
...
@property(nonatomic) __weak id <SimilarRecAlbumItemViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)touchedItemViewInside:(id)arg1;
- (void)updateWithAlbumInfo:(id)arg1;
