...
@class ASIDataDecompressor, NSArray, NSData, NSDate, NSDictionary, NSError, NSInputStream, NSLock, NSMutableArray, NSMutableData, NSMutableDictionary, NSNumber, NSOutputStream, NSRecursiveLock, NSString, NSTimer, NSURL;
...
@interface ASIHTTPRequest : NSOperation <NSCopying>
{
    ...
    _Bool isAccessedWhileWifiOnlyRequest;
    _Bool _isDebuging;
    _Bool _forbiddenFreeFlow;
    _Bool _isBandwidthThrottled;
    _Bool _shouldThrottleBandwidthForWWANOnly;
    int _threadType;
    SEL didBindConnectionSelector;
    unsigned long long _totalResourceLength;
    unsigned long long _maxReadBytesEachRead;
    id _context;
    NSString *_serverIpAddress;
    double _maxRunningTime;
    NSDate *_startRunningTime;
    unsigned long long _bandwidthUsedInLastSecond;
    NSDate *_bandwidthMeasurementDate;
    NSLock *_bandwidthThrottlingLock;
    unsigned long long _maxBandwidthPerSecondValue;
    NSDate *_throttleWakeUpTime;
    NSMutableArray *_bandwidthUsageTracker;
    unsigned long long _averageBandwidthUsedPerSecond;
    long long _occurTimesOf302;
    NSDate *_firstTimeOf302;
}

+ (_Bool)isValidPacFile:(id)arg1 pacURL:(id)arg2;
+ (id)pacFileKey:(id)arg1 pacURL:(id)arg2;
+ (_Bool)isValidPacFile:(id)arg1;
+ (_Bool)existFreeConnectionForURL:(id)arg1;
...
+ (void)runAudioRequests;
+ (void)runDownloadRequests;
+ (void)runProtocolRequests;
+ (void)runRequests;
+ (id)threadForRequest:(id)arg1;
+ (_Bool)enableASIMutipleThread;
...
+ (void)initialize;
@property(retain) NSDate *firstTimeOf302; // @synthesize firstTimeOf302=_firstTimeOf302;
@property long long occurTimesOf302; // @synthesize occurTimesOf302=_occurTimesOf302;
@property unsigned long long averageBandwidthUsedPerSecond; // @synthesize averageBandwidthUsedPerSecond=_averageBandwidthUsedPerSecond;
@property(retain) NSMutableArray *bandwidthUsageTracker; // @synthesize bandwidthUsageTracker=_bandwidthUsageTracker;
@property(retain) NSDate *throttleWakeUpTime; // @synthesize throttleWakeUpTime=_throttleWakeUpTime;
@property unsigned long long maxBandwidthPerSecondValue; // @synthesize maxBandwidthPerSecondValue=_maxBandwidthPerSecondValue;
@property _Bool shouldThrottleBandwidthForWWANOnly; // @synthesize shouldThrottleBandwidthForWWANOnly=_shouldThrottleBandwidthForWWANOnly;
@property _Bool isBandwidthThrottled; // @synthesize isBandwidthThrottled=_isBandwidthThrottled;
@property(retain) NSLock *bandwidthThrottlingLock; // @synthesize bandwidthThrottlingLock=_bandwidthThrottlingLock;
@property(retain) NSDate *bandwidthMeasurementDate; // @synthesize bandwidthMeasurementDate=_bandwidthMeasurementDate;
@property unsigned long long bandwidthUsedInLastSecond; // @synthesize bandwidthUsedInLastSecond=_bandwidthUsedInLastSecond;
@property(retain, nonatomic) NSDate *startRunningTime; // @synthesize startRunningTime=_startRunningTime;
...
@property _Bool isDebuging; // @synthesize isDebuging=_isDebuging;
@property(retain, nonatomic) id context; // @synthesize context=_context;
@property(nonatomic) int threadType; // @synthesize threadType=_threadType;
@property unsigned long long maxReadBytesEachRead; // @synthesize maxReadBytesEachRead=_maxReadBytesEachRead;
@property unsigned long long totalResourceLength; // @synthesize totalResourceLength=_totalResourceLength;
@property(nonatomic) _Bool isAccessedWhileWifiOnlyRequest; // @synthesize isAccessedWhileWifiOnlyRequest;
...
@property SEL didBindConnectionSelector; // @synthesize didBindConnectionSelector;
...
- (void)setCookieFromTag:(unsigned int)arg1;
- (id)_getIpAddressFromInputStream:(id)arg1;
- (id)getServerIpAddress;
...
- (unsigned long long)getAverageBandwidthUsedPerSecond;
...
- (void)checkWangsuResponseHeaders;
- (void)parseStringEncodingFromHeaders;
- (void)process302RedirectForWangsuFreeFlow:(int)arg1;
- (_Bool)willRedirect;
...
- (_Bool)isFinished;
- (_Bool)isConcurrent;
- (void)startAsynchronousForHighPriorityCgi;
- (void)startAsynchronousForStream;
- (void)startAsynchronousForCgi;
