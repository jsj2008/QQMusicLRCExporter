...
@class IDToolbarButton, LowVolumePopupView, MainScreenID5View, MainScreenView, NSData, NSDate, NSString, NSTimer, RAPIMainScreenConfig, UIImage;
...
{
    long long toolbarButtonTargetScreenIndices[8];
    IDToolbarButton *toolbarButtons[8];
    _Bool currentToolbarButtonHoverable[8];
    _Bool currentToolbarButtonClickable[8];
    _Bool currentToolbarButtonVisible[8];
    NSString *currentToolbarButtonTooltip[8];
    long long currentToolbarButtonImageId[8];
    ...
    LowVolumePopupView *_lowVolumePopupView;
    ...
    NSData *_currentID5CoverArtImageData;
}

@property(retain) NSData *currentID5CoverArtImageData; // @synthesize currentID5CoverArtImageData=_currentID5CoverArtImageData;
...
@property(retain) LowVolumePopupView *lowVolumePopupView; // @synthesize lowVolumePopupView=_lowVolumePopupView;
...
- (void)delegate_onJumpToTrackStart;
...
- (void)setCheckmarkPosition:(long long)arg1;
...
- (void)updateCoverArt;
- (void)resendCoverArtAndMetadataID5;
