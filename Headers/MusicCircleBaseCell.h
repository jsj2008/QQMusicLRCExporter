...
@property(nonatomic) _Bool bCanShowDelete; // @synthesize bCanShowDelete=_bCanShowDelete;
...
- (void)updateUI;
- (void)setSanjiaoHidden:(_Bool)arg1;
- (void)setIsCanShowDelete:(_Bool)arg1;
