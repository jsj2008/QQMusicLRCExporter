...
@property(retain, nonatomic) NSOutputStream *outputStream; // @synthesize outputStream;
...
@property(nonatomic) __weak id <SKPSMTPMessageDelegate> delegate; // @synthesize delegate;
