...
#import "FirstReleaseScrollViewDataSource-Protocol.h"
#import "FirstReleaseScrollViewDelegate-Protocol.h"
...
@protocol FirstReleaseCellDelegate;
...
- (void).cxx_destruct;
- (void)firstReleaseScrollView:(id)arg1 didTapOnItemAtIndex:(long long)arg2;
- (id)itemTypeInFRScrollView:(id)arg1;
- (id)firstReleaseScrollView:(id)arg1 subtitleForItemAtIndex:(long long)arg2;
- (id)firstReleaseScrollView:(id)arg1 titleForItemAtIndex:(long long)arg2;
- (id)firstReleaseScrollView:(id)arg1 imageForItemAtIndex:(long long)arg2;
- (long long)numberOfItemsInFRScrollView:(id)arg1;
