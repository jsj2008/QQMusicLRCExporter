...
@class IDButton, IDInstrumentCluster, IDMultimediaInfo, IDStatusBar, NSDictionary, NSString;

@interface RAPIHmiProvider : NSObject <IDHmiProvider>
{
    IDMultimediaInfo *_multimediaInfo;
    IDStatusBar *_hmiStatusBar;
    IDButton *_entryButtonRAPI;
...
@property(readonly) IDButton *entryButtonRAPI; // @synthesize entryButtonRAPI=_entryButtonRAPI;
