...
@class KKMediaRootViewController, NSArray, NSString, TVKMediaViewController, UIView, UIViewController;
@protocol TVKMediaPlaybackDelegate;

@interface TVKMediaPlayer : NSObject <KKMediaPlayerEventProtocol, KKMediaPlayerUrlExchange, KKMediaPlayerControlProtocol, KKMediaPlayerPlayerItemExchange>
{
    _Bool _defaultUI;
    _Bool _isLive;
