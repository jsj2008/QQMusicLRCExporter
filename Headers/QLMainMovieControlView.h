...
@interface QLMainMovieControlView : QLMovieBaseControlView <QLMomentInputViewDelegate, UIGestureRecognizerDelegate, QLActionMenuDelegate, QLMPClarityListViewDelegate, QLMPComplexPanelViewDelegate, QLLiveTitleUpdateDelegate>
{
