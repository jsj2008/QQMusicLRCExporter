...
@class IDA4AProxyInfo, IDAppManifest, IDApplicationManagementService, IDAudioService, IDBackgroundTask, IDCdsService, IDEtchSession, IDHmiService, IDPiaService, IDVehicleInfo, IDVoiceRecorderService, IDWidgetHmiService, NSOperationQueue, NSURL, NSUndoManager;
