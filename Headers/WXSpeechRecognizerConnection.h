...
- (void)saveTimeOffset;
- (void)voiceEncodepInput:(char *)arg1 nInputSize:(int)arg2 pOutput:(char *)arg3 pOutputSize:(int *)arg4 isFirst:(_Bool)arg5;
- (void)reSet;
...
- (void)sendVoiceBytes:(void *)arg1 length:(unsigned int)arg2;
