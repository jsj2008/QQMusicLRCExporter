...
@interface WarningScreen : RAPIController <RAPIListScreenDelegate>
{
    NSString *_message;
    long long _backScreenIndex;
}

@property(nonatomic) long long backScreenIndex; // @synthesize backScreenIndex=_backScreenIndex;
