...
- (id)downloadImageByUrl:(id)arg1 progress:(CDUnknownBlockType)arg2 completed:(CDUnknownBlockType)arg3;
- (id)downloadImageWithURL:(id)arg1 inDirectoryPath:(id)arg2 options:(unsigned long long)arg3 progress:(CDUnknownBlockType)arg4 completed:(CDUnknownBlockType)arg5;
...
- (void)diskImageExistsForURL:(id)arg1 inDirectoryPath:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)diskImageExistsForURL:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)cachedImageExistsForURL:(id)arg1 inDirectoryPath:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)cachedImageExistsForURL:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (_Bool)diskImageExistsForURL:(id)arg1 inDirectoryPath:(id)arg2;
- (_Bool)diskImageExistsForURL:(id)arg1;
- (_Bool)cachedImageExistsForURL:(id)arg1 inDirectoryPath:(id)arg2;
