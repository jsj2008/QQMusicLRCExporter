...
@class BaseTabVC, CategoricalSongFolderListItem, NSArray, NSString, QMTabBar, UIControl, UIImage, UIImageView, UIScrollView, UIView;
...
- (void)resetTabBarTitleNum:(_Bool)arg1;
