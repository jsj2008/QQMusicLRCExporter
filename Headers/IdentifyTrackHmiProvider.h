...
@interface IdentifyTrackHmiProvider : NSObject <IDHmiProvider>
{
    IDMultimediaInfo *_multimediaInfo;
    IDStatusBar *_hmiStatusBar;
    IDButton *_entryButtonQQMusicRecognization;
...
@property(readonly) IDButton *entryButtonQQMusicRecognization; // @synthesize entryButtonQQMusicRecognization=_entryButtonQQMusicRecognization;
