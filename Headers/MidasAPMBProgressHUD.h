...
@protocol MidasAPMBProgressHUDDelegate;

@interface MidasAPMBProgressHUD : UIView
{
    _Bool useAnimation;
    ...
    int mode;
    float progress;
    id <MidasAPMBProgressHUDDelegate> delegate;
    UIColor *color;
    UIFont *labelFont;
...
@property _Bool horizontalLayout; // @synthesize horizontalLayout;
...
@property id <MidasAPMBProgressHUDDelegate> delegate; // @synthesize delegate;
