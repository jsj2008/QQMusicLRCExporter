...
- (int)sendToWtloginTran:(unsigned int)arg1 andAppid:(unsigned int)arg2 andRole:(unsigned int)arg3 andTranType:(int)arg4 andSt:(id)arg5 andA2:(id)arg6 andData:(id)arg7 andSvrTime:(unsigned int)arg8 andIsECDH:(unsigned char)arg9;
