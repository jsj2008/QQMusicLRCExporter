...
{
    int _voiceRecorderServiceState;
...
@property int voiceRecorderServiceState; // @synthesize voiceRecorderServiceState=_voiceRecorderServiceState;
...
- (void)session:(id)arg1 voiceRecorderService:(long long)arg2 handleVoiceRecorderEvent:(int)arg3 sequence:(long long)arg4 payload:(id)arg5;
