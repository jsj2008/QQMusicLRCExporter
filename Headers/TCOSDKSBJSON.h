...
#import "TCOSDKSBJSONBase.h"

#import "TCOSDKSBJSONParser-Protocol.h"
#import "TCOSDKSBJSONWriter-Protocol.h"

@class TCOSDKSBJSONParser, TCOSDKSBJSONWriter;

@interface TCOSDKSBJSON : TCOSDKSBJSONBase <TCOSDKSBJSONParser, TCOSDKSBJSONWriter>
{
    TCOSDKSBJSONParser *jsonParser;
