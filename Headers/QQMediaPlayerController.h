...
@class AVPictureInPictureController, AVPlayerItemVideoOutput, AVURLAsset, NSArray, NSMutableURLRequest, NSString, NSTimer, NSURL, NSURLConnection, QLAVPlayer, QLAVPlayerItem, UIView;

@interface QQMediaPlayerController : NSObject <QQMPlayback, AVPictureInPictureControllerDelegate>
{
    _Bool allowsAirPlay;
    ...
    AVPictureInPictureController *_qlPIPController0;
    AVPictureInPictureController *_qlPIPController1;
...
@property(retain, nonatomic) AVPictureInPictureController *qlPIPController1; // @synthesize qlPIPController1=_qlPIPController1;
@property(retain, nonatomic) AVPictureInPictureController *qlPIPController0; // @synthesize qlPIPController0=_qlPIPController0;
