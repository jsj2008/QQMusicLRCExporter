...
@class IDApplication, NSDate, NSString, RAPICarDescription, RAPIConfiguration, RAPIHmiProvider, RAPIItemLocation, RAPIPreviewManager, RAPIResources, RAPIScreenTable;
